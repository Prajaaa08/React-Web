        ...
        <Row className="d-flex justify-content-between">
          <Col lg="5">
            ...
            <p className="desc">
              ...
              similique nam accusamus eligendi perspiciatis minima animi{" "}
            </p>
            <div className="no mb-1 mt-4">
              <Link className="text-decoration-none">
                <i className="fa-brands fa-whatsapp"></i>
                <p className="m-0">+62 896-5254-2130</p>
              </Link>
            </div>
            <div className="mail">
              <Link className="text-decoration-none">
        ...
        <Row>
          <Col>
            <p className="text-center px-md-0 px-3">
              &copy; Copyright {new Date().getFullYear()} by <span className="fw-bold">Nabil Praja</span> , All Right Reserved
            </p>
          </Col>
        </Row>
      </Container>
